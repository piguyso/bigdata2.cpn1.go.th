<x-layout>
    <x-slot:title>โครงสร้างหน่วยงาน | IPST Chumphon</x-slot>
    ...
    <main class="py-16 md:py-24 space-y-12" x-data="{ activeTab: 'operations' }">
        ...
        <section class="max-w-7xl mx-auto px-6 text-center space-y-4">
            ...
            <p class="text-slate-500 text-sm max-w-2xl mx-auto leading-relaxed">
                คณะกรรมการและที่ปรึกษาผู้ร่วมจัดตั้งและขับเคลื่อนทางวิชาการ เพื่อส่งเสริมกระบวนการเรียนรู้อย่างยั่งยืน ประจำศูนย์พัฒนาครู สสวท. จังหวัดชุมพร
            </p>
        </section>
