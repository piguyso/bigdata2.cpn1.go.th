<x-layout>
    <x-slot:title>คลังเอกสารเผยแพร่ | IPST Chumphon</x-slot>
    ...
    <main class="py-16 md:py-24 space-y-12">
        ...
        <section class="max-w-7xl mx-auto px-6 text-center space-y-4">
            ...
            <p class="text-slate-500 text-sm max-w-2xl mx-auto leading-relaxed">
                ดาวน์โหลดคู่มือการอบรม แผนการสอน แบบฟอร์มอิเล็กทรอนิกส์ และเอกสารวิชาการต่างๆ ของศูนย์พัฒนาครู สสวท. จังหวัดชุมพร
            </p>
        </section>
