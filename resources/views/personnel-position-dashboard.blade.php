<x-layout>
    ...
    <div class="py-12 max-w-7xl mx-auto px-6" x-data='personnelPositionDashboard(@json($dashboardPayload), @json(route('api.personnel.position')))' x-init="fetchDashboard()">
        ...
        <div x-show="!loading && !hasAnyData()" class="bg-white border border-rose-100 rounded-3xl p-10 text-center" x-cloak>
        ...
        <div x-show="!loading && hasAnyData()" class="space-y-6" x-cloak>
