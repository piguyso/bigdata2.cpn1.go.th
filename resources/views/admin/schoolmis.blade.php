            ...
            function schoolmisManager() {
                return {
                    ...
                    confirmDeleteImport(item) {
                        window.showConfirm({
                            title: 'ยืนยันการลบข้อมูลนำเข้า SchoolMIS',
                            text: `คุณต้องการลบข้อมูลนำเข้า SchoolMIS ปี ${item.academic_year} รอบ ${item.term} ใช่หรือไม่? ข้อมูลผลคะแนนทั้งหมดในชุดนี้จะถูกลบออกจากระบบโดยสมบูรณ์`,
